...
from modules.indicator import INDICATOR_TYPES
...
"cert-domain" : direct_match,
"crypto-wallet" : direct_match,
"domain" : direct_match,
"domain_suffix" : direct_match,
"fb_pixel_id" : direct_match,
"adobe_analytics_id" : direct_match,
"sitemap_entries" : direct_match,
"ipms_domain_iprangeowner_cidr" : direct_match,
"ipms_domain_iprangeowner_ownerName" : direct_match,
"ipms_domain_iprangeowner_address" : direct_match,
"ipms_domain_nameserver" : iou_match,
"ipms_domain_otheripused" : iou_match,
"ipms_siteonthisip_now" : iou_match,
"ipms_siteonthisip_before" : iou_match,
"ipms_siteonthisip_broken" : iou_match,
"ipms_useragents" : iou_match,
"ip_shodan_hostnames" : direct_match,
"ip_shodan_ports" : iou_match,
"ip_shodan_vuln" : iou_match,
"ip_shodan_cpe" : iou_match,
"ga_id" : direct_match,
"ga_tag_id" : direct_match,
"ip" : direct_match,
"verification_id" : direct_match,
"yandex_tag_id" : direct_match,
"subnet" : direct_match,
"cdn-domain" : iou_match,
"cms" : direct_match,
"css_classes" : iou_match,
"header-nonstd-value" : direct_match,
"header-server" : direct_match,
"id_tags" : iou_match,
"iframe_id_tags" : iou_match,
"link_href" : iou_match,
"meta_generic" : iou_match,
"meta_social" : direct_match,
"script_src" : iou_match,
"uuid" : direct_match,
"whois_creation_date" : direct_match,
"whois_server" : direct_match,
"whois-registrar" : direct_match,
"wp-blocks" : iou_match,
"wp-categories" : iou_match,
"wp-pages" : iou_match,
"wp-posts" : iou_match,
"wp-tags" : iou_match,
"wp-users" : iou_match,
"urlscan_globalvariable": iou_match,
"urlscan_cookies": iou_match,
"urlscan_consolemessages": iou_match,
"urlscan_asn": direct_match,
"urlscan_domainsonpage": iou_match,
"urlscan_urlssonpage" : iou_match,
"urlscanhrefs" : iou_match,
"techstack" : iou_match,
"footer-text": direct_match,
"outbound-domain": iou_match,
"ads_txt": iou_match
...
def find_matches(data, comparison=None, result_dir=None) -> pd.DataFrame:
    ...
    all_matches["indicator_tier"] = all_matches[MATCH_TYPE].map(lambda type: INDICATOR_TYPES[type]['tier'])
    return all_matches
